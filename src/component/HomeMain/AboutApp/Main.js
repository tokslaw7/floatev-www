            ...
            <div className="col-lg-6">
              <div className="about_text">
                ...
                >
                  ...
                  <p>
                    Float's recommendation engine enables tracking of vehicle
                    usage, ownership & service costs, fuel costs, emissions. Its
                    Telematics IoT enabled OBD device & dashcam to connect
                    directly to the vehicle to pull data.
                  </p>
                </div>
                {dark ? (
                  <ul className="list">
