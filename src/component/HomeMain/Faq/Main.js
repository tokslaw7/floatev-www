                        ...
                        <div className="card" data-aos="fade-up" data-aos-duration="1500">
                            ...
                            <div id="collapseOne" className="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
                                ...
                                <p> FloatEV is a fleet product for small and medium size enterprises.
                                    ...
                                    FloatEV maintains and cares for the fleet </p>
                                </div>
                            </div>
                        </div>
                        <div className="card" data-aos="fade-up" data-aos-duration="1500">
                            ...
                            <div id="collapseTwo" className="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
                                <div className="card-body">
                                <p>Create an account and order your subscription online at www.floatev.com/getstarted
                        ...
                        <div className="card" data-aos="fade-up" data-aos-duration="1500">
                            <div className="card-header" id="headingThree">
                                ...
                                <button type="button" className={`btn btn-link ${activeFaq.c && "active"}`} onClick= {() => setActiveFaq(activeFaq.c ? {c : false} : {c : true})} data-toggle="collapse"
                                    data-target="#collapseThree">{activeFaq.c ? <i className="icon_faq icofont-minus"></i>  : <i className="icon_faq icofont-plus"></i>}What is process ?
                                    ?</button>
                                </h2>
                            </div>
